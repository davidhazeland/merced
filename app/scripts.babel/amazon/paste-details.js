function handlePasteClick() {
  chrome.storage.local.get("data", function (e) {
    ...
    setValue("enterAddressFullName", t.name), setValue("enterAddressAddressLine1", t.address1), setValue("enterAddressAddressLine2", t.address2), setValue("enterAddressCity", t.city), setValue("enterAddressStateOrRegion", t.province), setValue("enterAddressPostalCode", t.zip), setValue("enterAddressPhoneNumber", "" + t.phone)
